...
md"""
# B123. Orbita Terrestre. Integradores Simplécticos.
...
# ╔═╡ 03c77ffa-077e-4d7b-b95b-f893282fa695
length(q1[:,1])
...
println("El cambio en la energía utilizando un algoritmo velocity-Verlet es: ", round(abs(cq1[end,2] - cq1[1,2]),digits=10))
